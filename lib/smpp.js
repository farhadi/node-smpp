...
// Standard servers without proyxy protocol support
...
exports.connect = exports.createSession = function(url, listener) {
	...
	if (options.tls && !options.hasOwnProperty("rejectUnauthorized")) {
		options.rejectUnauthorized = false; // Allow self signed certificates by default
	}
