...
Metrics.prototype.arrayRemove = function(arr, value) {
...
Metrics.prototype.getConnectedClient = function(remoteAddress, remotePort) {
	let connectedClient = (remoteAddress || null)+":"+(remotePort || null);
	if (this.metrics.connected_list.hasOwnProperty([connectedClient])) {
		return this.metrics.connected_list[connectedClient];
	}
	return null;
}
